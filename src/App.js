...
const CFAddress = "0x2730C16b4bdaD921c4437bcFb507cE670502E2F2";
...
function App() {
  ...
  async function startCoinFlip() {
    if (typeof window.ethereum !== 'undefined') {
      ...
      const contract = new ethers.Contract(CFAddress, CoinFlip.abi, signer);
  ...
  async function endCoinFlip() {
    ...
    tx.wait();
    console.log(tx);
    let event = contract.on('CoinFinishedFlip', (winner) => {
